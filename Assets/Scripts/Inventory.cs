...
public class Inventory : MonoBehaviour
{
    ...
    {
        // We empty all slots from the inventory
        ...
        // We put visual to slots according to content
    ...
    {
        print("Use item : " + itemCurrentlySelected.itemName);
        CloseActionPanel();
    }

    public void EquipActionButton()
    {
        print("Equip item : " + itemCurrentlySelected.itemName);
        CloseActionPanel();
    }
